...
import type { GetProofReturnType } from "viem/_types/actions/public/getProof";
...
import {
  ...
  type ProposalPayloadSentEvent,
  type ProposalQueuedEvent,
  type ProposalVotingActivatedEvent,
  findProposalLogs,
  type getGovernanceEvents,
