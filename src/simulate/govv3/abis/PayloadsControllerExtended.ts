export const PAYLOADS_CONTROLLER_EXTENDED_ABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: 'messageOriginator', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint40', name: 'delay', type: 'uint40' },
    ],
    name: 'ExecutorSet',
    type: 'event',
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint40', name: 'payloadId', type: 'uint40' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint40', name: 'payloadId', type: 'uint40' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'originSender', type: 'address' },
      { indexed: true, internalType: 'uint256', name: 'originChainId', type: 'uint256' },
      { indexed: true, internalType: 'bool', name: 'delivered', type: 'bool' },
  ...
  {
    inputs: [{ internalType: 'uint40', name: 'payloadId', type: 'uint40' }],
    name: 'cancelPayload',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'enum PayloadsControllerUtils.AccessControl', name: '', type: 'uint8' },
      { internalType: 'uint40', name: '', type: 'uint40' },
    ],
    stateMutability: 'pure',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'enum PayloadsControllerUtils.AccessControl', name: 'accessControl', type: 'uint8' }],
    name: 'getExecutorSettingsByAccessControl',
    outputs: [
      {
        components: [
          { internalType: 'address', name: 'executor', type: 'address' },
          { internalType: 'uint40', name: 'delay', type: 'uint40' },
        ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'enum IPayloadsControllerCore.PayloadState', name: 'state', type: 'uint8' },
          { internalType: 'uint40', name: 'createdAt', type: 'uint40' },
          { internalType: 'uint40', name: 'queuedAt', type: 'uint40' },
          { internalType: 'uint40', name: 'executedAt', type: 'uint40' },
          { internalType: 'uint40', name: 'cancelledAt', type: 'uint40' },
          { internalType: 'uint40', name: 'expirationTime', type: 'uint40' },
          { internalType: 'uint40', name: 'delay', type: 'uint40' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'enum IPayloadsControllerCore.PayloadState', name: '', type: 'uint8' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
